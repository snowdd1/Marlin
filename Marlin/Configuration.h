...
// TITAN EXTRUDER:
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 764.526 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -5, -1.55 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 70
...
#define Z_PROBE_OFFSET_RANGE_MAX 100
...
// X5SA Pro TMC: Extruder seems inverted on titan!
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define ENABLE_LEVELING_FADE_HEIGHT //TODO reactivate after testing
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) } //original 50, 50, 4 (*60)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (340), (100), 20 } // right border RvM
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 330, 90, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 347, 50, (Z_MIN_POS + 1) } }
...
#define TOUCH_SCREEN
  ...
  // #define TOUCH_CALIBRATION_X -12316  // werte stimmen wohl nicht, RvM 20211101
  // #define TOUCH_CALIBRATION_Y   8981
  // #define TOUCH_OFFSET_X         340
  // #define TOUCH_OFFSET_Y         -20
  //#define TOUCH_ORIENTATION TOUCH_LANDSCAPE
  #define TOUCH_CALIBRATION_X -17172  // neue werte nach manueller calibierung
  #define TOUCH_CALIBRATION_Y 10950
  #define TOUCH_OFFSET_X 496
